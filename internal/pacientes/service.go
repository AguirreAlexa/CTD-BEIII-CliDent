...
type Service interface {
	...
	Save(ctx context.Context, id int, nombre, apellido string) (domain.Paciente, error)
...
func (s *service) Save(ctx context.Context, id int, nombre, apellido, domicilio, fechaAlta string, dni int) (domain.Paciente, error) {
