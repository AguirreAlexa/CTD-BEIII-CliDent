...
import (
	...
	"github.com/AguirreAlexa/clinica/pkg/web"
...
func (h *pacienteHandler) Post() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		p, err := h.pService.Save(ctx, *req.Nombre, *req.Apellido, *req.Domicilio, *req.DNI, *req.FechaAlta)
		if err != nil {
...
func (h *pacienteHandler) Delete() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		web.Success(ctx, 204, "Successful delete from paciente")
	}
}
